      ...
      class FriendPage < Pike::Elements::Pages::PropertiesPage
        ...
        def initialize(friendship)
          ...
          @delete_button.clicked do |element, event|
            Pike::Session.show_dialog(event, RubyApp::Elements::Dialogs::ConfirmationDialog.new('Confirm', 'Are you sure you want to remove this friend?  Any shared projects and activities will be removed momentarily.')) do |_event, response|
              if response
