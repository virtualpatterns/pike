...
add_step! (RubyApp::Element::ExecutedEvent)                   { |event| event.execute { Pike::Introduction.create_introduction!(Pike::Session.identity.user.uri, "Friend 01.1 of #{Pike::Session.identity.user.id}", 'Be my friend!') } }
...
add_step! (RubyApp::Element::ExecutedEvent)                   { |event| event.execute { Pike::Introduction.create_introduction!(Pike::Session.identity.user.uri, "Friend 01.2 of #{Pike::Session.identity.user.id}", 'Be my friend!') } }
add_step! (RubyApp::Element::ExecutedEvent)                   { |event| event.assert_exists_link('Back') }
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.click_link('Back') }
add_step! (RubyApp::Elements::Mobile::Page::ShownEvent)       { |event| event.assert_exists_link('Friends') }
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.click_link('Friends') }
...
add_step! (RubyApp::Element::ExecutedEvent)                   { |event| event.execute { Pike::Introduction.create_introduction!("Friend 02 of #{Pike::Session.identity.user.id}", Pike::Session.identity.user.uri, 'Be my friend!') } }
add_step! (RubyApp::Element::ExecutedEvent)                   { |event| event.assert_exists_link('Back') }
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.click_link('Back') }
add_step! (RubyApp::Elements::Mobile::Page::ShownEvent)       { |event| event.assert_exists_link('Back') }
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.click_link('Back') }
...
add_step! (RubyApp::Element::ExecutedEvent)                   { |event| event.execute { Pike::Introduction.create_introduction!("Friend 03 of #{Pike::Session.identity.user.id}", Pike::Session.identity.user.uri, 'Be my friend!') } }
add_step! (RubyApp::Element::ExecutedEvent)                   { |event| event.assert_exists_link('Back') }
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.click_link('Back') }
add_step! (RubyApp::Element::UpdatedEvent)                    { |event| event.assert_exists_link('tap to manage friends') }
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.click_link('tap to manage friends') }
...
add_step! (RubyApp::Element::ExecutedEvent)                   { |event| event.execute { Pike::Introduction.create_introduction!("Friend 04 of #{Pike::Session.identity.user.id}", Pike::Session.identity.user.uri, 'Be my friend!') } }
add_step! (RubyApp::Element::ExecutedEvent)                   { |event| event.assert_exists_link('Back') }
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.click_link('Back') }
add_step! (RubyApp::Element::UpdatedEvent)                    { |event| event.assert_exists_link('tap to manage friends') }
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.click_link('tap to manage friends') }
