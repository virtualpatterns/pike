...
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.update_search('tap to search by name', "Friend 01 of #{Pike::Session.identity.user.id}") }
add_step! (RubyApp::Element::UpdatedEvent)                    { |event| event.assert_exists_link("Friend 01 of #{Pike::Session.identity.user.id}") }
...
add_step! (RubyApp::Element::UpdatedEvent)                    { |event| event.assert_not_exists_link("Friend 03 of #{Pike::Session.identity.user.id}") }
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.execute {} }
