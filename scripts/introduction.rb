...
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.click_link("Friend 3 of #{Pike::Session.identity.user.id}") }
...
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.click_link("Friend 4.1 of #{Pike::Session.identity.user.id}") }
...
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.click_link("Friend 4.2 of #{Pike::Session.identity.user.id}") }
