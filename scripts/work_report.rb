...
add_step! (RubyApp::Element::ExecutedEvent)                   { |event| event.execute { Pike::Session.identity.user.create_work!('Project 1', 'Activity 1', event.today.week_start + 0, 1 * 60 * 60, 'Note 1') } }
add_step! (RubyApp::Element::ExecutedEvent)                   { |event| event.execute { Pike::Session.identity.user.create_work!('Project 2', 'Activity 2', event.today.week_start + 1, 2 * 60 * 60, 'Note 2') } }
add_step! (RubyApp::Element::ExecutedEvent)                   { |event| event.execute { Pike::Session.identity.user.create_work!('Project 3', 'Activity 3', event.today.week_start + 2, 3 * 60 * 60, 'Note 3') } }
add_step! (RubyApp::Element::ExecutedEvent)                   { |event| event.execute { Pike::Session.identity.user.create_work!('Project 4', 'Activity 4', event.today.week_start + 3, 4 * 60 * 60, 'Note 4') } }
add_step! (RubyApp::Element::ExecutedEvent)                   { |event| event.execute { Pike::Session.identity.user.create_work!('Project 5', 'Activity 5', event.today.week_start + 4, 5 * 60 * 60, 'Note 5') } }
add_step! (RubyApp::Element::ExecutedEvent)                   { |event| event.execute { Pike::Session.identity.user.create_work!('Project 6', 'Activity 6', event.today.week_start + 5, 6 * 60 * 60, 'Note 6') } }
add_step! (RubyApp::Element::ExecutedEvent)                   { |event| event.execute { Pike::Session.identity.user.create_work!('Project 7', 'Activity 7', event.today.week_start + 6, 7 * 60 * 60, 'Note 7') } }
...
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.assert_exists_text('Note 1') }
...
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.assert_exists_text('Note 2') }
...
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.assert_exists_text('Note 3') }
...
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.assert_exists_text('Note 4') }
...
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.assert_exists_text('Note 5') }
...
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.assert_exists_text('Note 6') }
...
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.assert_exists_text('Note 7') }
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.execute {} }
