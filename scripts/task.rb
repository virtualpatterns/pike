...
add_step! (RubyApp::Elements::Mobile::Page::ShownEvent)       { |event| event.click_link('Done') }
...
add_step! (RubyApp::Element::AssertedEvent)                   { |event| event.click_list_link('Project 6') }
